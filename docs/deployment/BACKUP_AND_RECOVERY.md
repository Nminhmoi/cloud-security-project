...
Cách sao lưu và khôi phục phụ thuộc vào việc bạn dùng SQLite trên máy cá nhân hay Amazon RDS. Sau khi sao lưu, cần kiểm tra tính toàn vẹn hoặc thử khôi phục để biết bản sao có dùng được khi xảy ra sự cố hay không.
...
Dung lượng AWS Backup phát sinh chi phí. Vault đặt `force_destroy=false`, vì vậy Terraform không thể xóa các điểm khôi phục vẫn còn thời hạn lưu.
...
Kiểm thử khôi phục tạo RDS resource tạm thời nên phát sinh chi phí và mặc định bị
